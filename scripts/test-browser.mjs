...
try {
  ...
  for(const script of (process.env.BROWSER_TESTS?.split(',')??['layout-mobile-browser.mjs','usability-browser.mjs','pending-guidance-browser.mjs','messages-browser.mjs','oradores-browser.mjs','integration-browser.mjs'])) {
    console.log('\nNavegador: '+script)
