...
test('desbloqueio aceita somente senha de Admin ativo', () => {
  const users = {
    admin:{ nome:'Admin', senha:'42754', ativo:true, apps:{ mestre:true, tarefas:true, escala:true, programacao:true, secretario:true } },
  ...
  assert.equal(validAdminPassword(users, '42754'), true)
