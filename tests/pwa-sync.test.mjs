...
import { refreshServiceWorkerWeekly, shouldRefreshServiceWorker } from '../src/pwa-sync.ts'
...
test('service worker bloqueado nao quebra a inicializacao', () => {
  assert.doesNotThrow(() => refreshServiceWorkerWeekly(undefined, 'sw-test'))
})
