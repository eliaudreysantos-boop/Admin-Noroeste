...
export const oradoresRef = reference('tarefas/discursos')
export const oradoresProgramacaoRef = reference('tarefas/discursos/programacao')
export const oradoresTemasRef = reference('tarefas/discursos/temas')
export const oradoresCadastroRef = reference('tarefas/discursos/oradores')
export const oradoresCongregacoesRef = reference('tarefas/discursos/congregacoes')
export const oradoresHistoricoRef = reference('tarefas/discursos/historicoTemas')
export const oradoresEventosRef = reference('tarefas/events')
