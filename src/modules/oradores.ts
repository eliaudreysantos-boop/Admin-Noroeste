...
import {
  ...
  speakerPendingItems, validIsoDate, scheduleBaseForEdit, isDuplicateSchedule, speakerLinkOptions,
...
type TaskPerson = { name?:string; active?:boolean; masterId?:string }
